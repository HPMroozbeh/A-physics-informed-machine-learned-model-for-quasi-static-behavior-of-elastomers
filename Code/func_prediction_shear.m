function [u,v] = func_prediction_shear(xx) 
...
stretch_L = linspace(1,3.0748,50);
stretch_U = linspace(3.0748,1.2322,50);
...
for i=1:nos_L
    ...
    yy = zeros(3,3);
    F = [stretch_L(i) 0 0;0 (stretch_L(i))^0 0;0 0 (stretch_L(i))^-1];
...
for i=1:nos_U
    ...
    yy = zeros(3,3);
    F = [stretch_U(i) 0 0;0 (stretch_U(i))^0 0;0 0 (stretch_U(i))^-1];
